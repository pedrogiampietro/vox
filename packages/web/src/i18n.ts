...
const TRANSLATIONS: readonly Translation[] = [
  ...
  ['só você vê', 'only you see this', 'solo tú lo ves'],
  ['Um perfil com a sua cara.', 'A profile that feels like you.', 'Un perfil con tu estilo.'],
  ['Escolha sua capa, encontre seu estilo e faça parte da conversa.', 'Choose your cover, find your style and join the conversation.', 'Elige tu portada, encuentra tu estilo y sé parte de la conversación.'],
  ['Aparência', 'Appearance', 'Apariencia'],
  ['Sobre mim', 'About me', 'Sobre mí'],
  ['CAPA DO PERFIL', 'PROFILE COVER', 'PORTADA DEL PERFIL'],
  ['O cenário da sua identidade.', 'The setting for your identity.', 'El escenario de tu identidad.'],
  ['Capas prontas', 'Ready-made covers', 'Portadas listas'],
  ...
  ['OU ESCOLHA UMA CAPA', 'OR CHOOSE A COVER', 'O ELIGE UNA PORTADA'],
  ['Uma foto, um personagem, você.', 'A photo, a character, you.', 'Una foto, un personaje, tú.'],
  ['SEU ESTILO', 'YOUR STYLE', 'TU ESTILO'],
  ['Os detalhes fazem a diferença.', 'Details make the difference.', 'Los detalles marcan la diferencia.'],
  ['Combine a capa e a moldura.', 'Match your cover and frame.', 'Combina la portada y el marco.'],
  ['Tudo salvo. Do seu jeito.', 'All saved. Your way.', 'Todo guardado. A tu manera.'],
  ['Você tem alterações não salvas.', 'You have unsaved changes.', 'Tienes cambios sin guardar.'],
  ...
  ['enviar banner', 'upload cover', 'subir portada'],
  ['trocar banner', 'change cover', 'cambiar portada'],
  ['trocar avatar', 'change avatar', 'cambiar avatar'],
  ['enviar avatar', 'upload avatar', 'subir avatar'],
  ['Escolher uma imagem para o banner', 'Choose an image for the cover', 'Elegir una imagen para la portada'],
  ['Arraste uma imagem aqui · proporção 3:1', 'Drop an image here · 3:1 ratio', 'Arrastra una imagen aquí · proporción 3:1'],
  ['Arraste sua foto aqui. Ajuste o recorte do seu jeito.', 'Drop your photo here. Adjust the crop your way.', 'Arrastra tu foto aquí. Ajusta el recorte a tu manera.'],
  ['JPG, PNG ou WebP · até 10 MB', 'JPG, PNG or WebP · up to 10 MB', 'JPG, PNG o WebP · hasta 10 MB'],
  ['Escolha JPG, PNG ou WebP.', 'Choose JPG, PNG or WebP.', 'Elige JPG, PNG o WebP.'],
  ...
  ['NA LISTA DE CANAIS', 'IN THE CHANNEL LIST', 'EN LA LISTA DE CANALES'],
  ['Sua identidade, do cartão à conversa. As mudanças aparecem para todos ao salvar.', 'Your identity, from profile card to conversation. Changes appear for everyone when saved.', 'Tu identidad, de la tarjeta a la conversación. Los cambios aparecen para todos al guardar.'],
  ['Ajustar banner', 'Adjust cover', 'Ajustar portada'],
  ['Arraste para reposicionar e use o zoom.', 'Drag to reposition and use zoom.', 'Arrastra para reposicionar y usa el zoom.'],
  ['Área de recorte do banner. Use as setas para reposicionar.', 'Cover crop area. Use the arrow keys to reposition.', 'Área de recorte de la portada. Usa las flechas para reposicionar.'],
  ['Zoom do banner', 'Cover zoom', 'Zoom de la portada'],
  ...
  ['organizar canal', 'organize channel', 'organizar canal'],
  ['mover para raiz (fim)', 'move to root (end)', 'mover a la raíz (final)'],
  ['mover depois de', 'move after', 'mover después de'],
  ['mover para dentro de', 'move inside', 'mover dentro de'],
  ['antes', 'before', 'antes'],
  ['dentro', 'inside', 'dentro'],
  ['depois', 'after', 'después'],
  ['na raiz', 'at root', 'en la raíz'],
  ['arraste para antes/depois ou sobre outro para criar subcanal; solte no espaço vazio para raiz', 'drag before/after or onto another channel to create a sub-channel; drop on empty space for root', 'arrastra antes/después o sobre otro canal para crear un subcanal; suelta en el espacio vacío para la raíz'],
  ['canal lotado · arraste para antes/depois ou sobre outro para criar subcanal; solte no espaço vazio para raiz', 'channel is full · drag before/after or onto another channel to create a sub-channel; drop on empty space for root', 'canal lleno · arrastra antes/después o sobre otro canal para crear un subcanal; suelta en el espacio vacío para la raíz'],
  ...
  ['atualizar dispositivos', 'refresh devices', 'actualizar dispositivos'],
  ['atualizando…', 'refreshing…', 'actualizando…'],
  ['seu navegador não disponibiliza a lista de dispositivos de áudio', 'your browser does not provide an audio device list', 'tu navegador no ofrece una lista de dispositivos de audio'],
  ['permita o acesso ao microfone para listar suas entradas de áudio', 'allow microphone access to list your audio inputs', 'permite el acceso al micrófono para listar tus entradas de audio'],
  ['nenhum dispositivo adicional foi disponibilizado pelo sistema', 'no additional device was provided by the system', 'el sistema no proporcionó ningún dispositivo adicional'],
  ['não foi possível consultar os dispositivos de áudio', 'audio devices could not be queried', 'no fue posible consultar los dispositivos de audio'],
  ['não foi possível selecionar essa saída de áudio', 'that audio output could not be selected', 'no fue posible seleccionar esa salida de audio'],
